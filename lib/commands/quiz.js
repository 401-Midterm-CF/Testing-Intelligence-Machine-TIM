...
module.exports = {
  ...
  async execute(message, args, memberData) {
    if(memberData.vault <= 0){
      message.channel.send('https://tenor.com/view/you-aint-got-no-money-broke-no-money-called-out-real-gif-9727593')
      return;
    }
    ...
    if (userAnswer.toLowerCase() === rightAnswer.toLowerCase()) {
      ...
      message.channel.send('Well done, old Chap!');
    } else {
      message.channel.send('Bullocks, better luck next time old Sport!');
